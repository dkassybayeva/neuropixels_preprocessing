...
last_spike_sesh2_ms = int(np.ceil(last_spike_sesh2 / fs * 1000))
...
dump(results, output_dir + f'spike_mat_{session1}_in_ms.npy', compress=3)

results = {'spike_mat': spike_mat_sesh2, 'row_cluster_id': good_clusters}
dump(results, output_dir + f'spike_mat_{session2}_in_ms.npy', compress=3)
print('\nSaved to ' + output_dir)
